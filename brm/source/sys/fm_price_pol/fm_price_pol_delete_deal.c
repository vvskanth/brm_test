/* continuus file information --- %full_filespec: fm_price_pol_delete_deal.c~5:csrc:1 % */
/*******************************************************************
 *
 *  @(#) %full_filespec: fm_price_pol_delete_deal.c~5:csrc:1 %
 *
...
#ifndef lint
static  char    Sccs_id[] = "@(#)%Portal Version: fm_price_pol_delete_deal.c:ServerIDCVelocityInt:1:2006-Sep-06 16:47:03 %";
#endif
...
#define FILE_SOURCE_ID  "fm_price_pol_delete_deal.c (1.7)"
