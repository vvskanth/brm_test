...
#	Locale:  es ( Spanish )
#
#	Domain:  config_device_state_apn (version = 1)
#
#   Rules:
#
#	[1] Uniqueness:
...
#	    this APN Device States file. If there are duplicate entries,
...
#	    with a backslash, for example "Delete \"unneeded\" archivos."
...
#	    =====
#	    This uniqueness must be ensured while creating or updating
#	    this APN Device States file. Please see the note about 
#	    uniqueness above.
#
#	    The id's and version's chosen in this file should be kept in
#	    sync with the pin_device_state_apn configuration file.
#
#	[6] String Version:
#
...
DOMAIN = "config_device_state_apn" ;
STR
        ID = 0 ;
        VERSION = 1 ;
