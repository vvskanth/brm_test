...
STR
     ID = 1 ;
     VERSION = 1 ;
     STRING = "La alerta %ALERT_NAME ha traspasado los valores de umbral definidos." ;
END
STR
     ID = 2 ;
     VERSION = 1 ;
     STRING = "La alerta %ALERT_NAME ha traspasado los valores de umbral definidos para el período desde %START_TIME hasta %END_TIME. %LINE_BREAK La alerta se configura del modo siguiente: %LINE_BREAK Tipo de objeto = %OBJECT_TYPE %LINE_BREAK Filtro = %FILTERS %LINE_BREAK Valores de umbral = %THRESHOLD_VALUES" ;
END
