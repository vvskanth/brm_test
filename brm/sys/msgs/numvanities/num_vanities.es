...
#	Locale:  es ( Spanish )
#
#	Domain:  device_num_vanities (version = 1)
#
#   Rules:
#
#	[1] Uniqueness:
...
#	    this Number Vanity file. If there are duplicate entries,
...
#	    =====
#	    This uniqueness must be ensured while creating or updating
#	    this Number Vanity file. Please see the note about 
#	    uniqueness above.
#
#	[6] String Version:
#
...
STR
	ID = 1 ;
	VERSION = 1 ;
	STRING = "sample_vanity_1" ;
END
STR
	ID = 2 ;
	VERSION = 1 ;
	STRING = "sample_vanity_2" ;
END
