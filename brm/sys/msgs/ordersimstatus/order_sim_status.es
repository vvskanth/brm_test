...
#	Locale:  es ( Spanish )
#
#	Domain:  order_sim_status (version = 1)
#
#   Rules:
#
#	[1] Uniqueness:
...
#	    this order sim status file. If there are duplicate entries,
...
#	    =====
#	    This uniqueness must be ensured while creating or updating
#	    this order sim status file. Please see the note about 
#	    uniqueness above.
#
#	    The id's and version's chosen in this file should be kept in
#	    sync with the pin_sim configuration file.
#
#	[6] String Version:
#
