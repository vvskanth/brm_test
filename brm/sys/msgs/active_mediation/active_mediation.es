...
STR
	ID = 3 ;
	VERSION = 1 ;
	STRING = "Caducidad de notificación" ;
END
STR
	ID = 4 ;
	VERSION = 1 ;
	STRING = "Intervalo de notificación" ;
END
STR
	ID = 5 ;
	VERSION = 1 ;
	STRING = "Umbral de flujo" ;
END
STR
	ID = 6 ;
	VERSION = 1 ;
	STRING = "Recurso para umbral" ;
END
STR
	ID = 7 ;
	VERSION = 1 ;
	STRING = "Hora de notificación" ;
END
