...
##########################################################################
#
#   File:  batch_suspense_reason_code.ES
#
#   Description:
#
...
#	Locale:  ES ( Español )
#
#	Domain:  config_batch_suspense_reason_code (version = 1)
#
#   Rules:
#
#	[1] Uniqueness:
...
#	    =====
#	    This uniqueness must be ensured while creating or updating
#	    this Batch Suspense Reason Code file. Please see the note about 
#	    uniqueness above.
#
#	    The id's and version's chosen in this file should be kept in
#	    sync with the pin_batch_suspense_reason_code configuration file.
#
#	[6] String Version:
#
...
STR
	ID = 1 ;
	VERSION = 1 ;
	STRING = "Error de análisis en la cadena de entrada" ;
END
STR
	ID = 2 ;
	VERSION = 1 ;
	STRING = "Número de secuencia no válido o fallo en control de secuencia." ;
END
