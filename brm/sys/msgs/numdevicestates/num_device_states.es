...
#	Locale:  es ( Spanish )
#
#	Domain:  config_device_state_num (version = 1)
#
#   Rules:
#
#	[1] Uniqueness:
...
#	    this Number Device States file. If there are duplicate entries,
...
#	    =====
#	    This uniqueness must be ensured while creating or updating
#	    this Number Device States file. Please see the note about 
#	    uniqueness above.
#
#	    The id's and version's chosen in this file should be kept in
#	    sync with the pin_device_state_num configuration file.
#
#	[6] String Version:
#
...
DOMAIN = "config_device_state_num" ;
STR
	ID = 0 ;
	VERSION = 1 ;
...
STR
        ID = 5 ;
        VERSION = 1 ;
        STRING = "Nuevo número adoptado" ;
END
STR
        ID = 6 ;
        VERSION = 1 ;
        STRING = "Asignado temporal" ;
END
STR
        ID = 7 ;
        VERSION = 1 ;
        STRING = "Repatriado en cuarentena" ;
END
STR
        ID = 8 ;
        VERSION = 1 ;
...
STR
        ID = 9 ;
        VERSION = 1 ;
        STRING = "Número migrado en cuarentena" ;
END
STR
        ID = 10 ;
        VERSION = 1 ;
        STRING = "Número migrado" ;
END
