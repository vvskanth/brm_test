...
##########################################################################
#
#   File:  gsm_features_and_profiles_states.es
#
#   Description:
#
...
#	Locale:  es ( Spanish )
#
#	Domain:  gsm_features_and_profiles_states (version = 1)
#
#   Rules:
#
#	[1] Uniqueness:
...
DOMAIN = "gsm_features_and_profiles_states" ;
STR
	ID = 0 ;
	VERSION = 1 ;
	STRING = "Falta de suministro" ;
END
STR
	ID = 1 ;
	VERSION = 1 ;
...
STR
	ID = 4 ;
	VERSION = 1 ;
	STRING = "Sin suministro" ;
END
STR
	ID = 5 ;
	VERSION = 1 ;
	STRING = "Fallo en la falta de suministro" ;
END
STR
	ID = 6 ;
	VERSION = 1 ;
	STRING = "Sin suministrar" ;
END
STR
	ID = 7 ;
	VERSION = 1 ;
